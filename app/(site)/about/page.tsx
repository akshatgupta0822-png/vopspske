        ...
        <SectionReveal delay={300}>
          <div className="mt-12">
            <div className="relative group">
              ...
              <ScrollRevealImage
                src="/images/meditation-circle.png"
        ...
        <SectionReveal delay={340}>
          <div id="chapters" className="mt-16">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              {/* Enhanced Delhi */}
              <Card className="hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover-lift group cursor-pointer bg-gradient-to-br from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 transform-gpu">
                <CardContent className="p-6 relative">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-10 h-10 rounded-lg bg-green-100 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                      <Building2 className="w-5 h-5 text-green-600 group-hover:animate-pulse" />
                    </div>
                    <h3 className="font-semibold group-hover:text-green-700 transition-colors duration-300">
                      Delhi Chapter
                    </h3>
                  </div>
